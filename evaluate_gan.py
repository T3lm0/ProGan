...
# --- Configuración ---
SOURCE_REAL_IMAGES_PATH = '/home/telmo/Escritorio/TFG/Codigo/datos/outDat/0'  # Carpeta de imágenes reales
SOURCE_GENERATED_IMAGES_PATH = 'generated_images'                              # Carpeta de imágenes generadas
NUM_REAL_IMAGES_FOR_EVAL = 2000                                                # Cuántas imágenes reales usar
NUM_GENERATED_IMAGES_FOR_EVAL = 2000                                           # Cuántas imágenes generadas usar
